            ...
            get
            {
                if(_cameraPreviewRT == null)
                {
                    ...
                    if(ClampResolution(ref resX, ref resY, _4kWidth, _4kHeight) && !issuedPreviewResolutionWarning)
                    {
                        ...
                        EditorScreenshotLogger.LogWarning($"Preview resolution gets clamped to 4k resolution ({_4kWidth}x{_4kHeight}). Going over this value could make the preview borders not match your final screenshot resolution.");
                    }
